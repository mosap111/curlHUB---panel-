...
5. **المصادقة الثنائية (2FA TOTP - الميزة الجديدة):**
   * حماية تسجيل الدخول لتطبيق لوحة التحكم باستخدام تطبيق مصادقة مثل Google Authenticator، لمنع أي دخول غير مصرح به حتى لو تم تسريب كلمة المرور.
